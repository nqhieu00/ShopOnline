...
<link
	href="<c:url value='/template/web/css/styles.css" rel="stylesheet'/>" />
</head>
<body>
	...
	<script
		src="<c:url value='https://cdn.jsdelivr.net/npm/bootstrap@5.1.0/dist/js/bootstrap.bundle.min.js'/>"></script>
	<!-- Core theme JS-->
